          ...
          <div className="welcome-wrapper">
            ...
            <div className="welcome-content-wrapper">
              <div className="welcome-content">
                Wir sind ein kleiner Verein im Herzen von Sendling. Egal ob jung
                oder alt, wer Lust am Fußball hat und einen respektvollen Umgang
                schätzt ist hier an der richtigen Adresse. Für Probetrainings
                bitte den Trainer der jeweiligen Mannschaft kontaktieren.
              </div>
            </div>
          </div>
        </div>
